...
function gmp_enqueue_video_scripts() {
        ...
        wp_enqueue_script( 'gmp-flowplayer', GMP_VIDEO_DIR_URI . 'js/flowplayer/flowplayer-3.2.6.min.js' , array(), '3.2.6', false );
    ...
    $height = $height           ? $height    : ceil( $width*.5625 );
        ...
        $video =    '<a href="'. $file .'" class="flowplayer-video" '. $style .' id="player-'. $id .'"></a>
                    <script type="text/javascript">'.
                        'flowplayer("player-'. $id .'", {src:"'. GMP_VIDEO_DIR_URI .'js/flowplayer/flowplayer-3.2.7.swf", wmode: \'opaque\'}, {
                            playlist: [
